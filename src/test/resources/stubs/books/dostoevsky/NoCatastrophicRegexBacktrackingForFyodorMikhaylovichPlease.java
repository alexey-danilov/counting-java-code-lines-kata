package not.real.pkg.name.open.domain.dostoyevsky.idiot.part.one

/**
 * Part I of Dostoyevsky's 'Idiot'.
 * NOTE: whole book causes catastrophic backtracking or other regex shenanigans
 * on most regexes I've tested so far. But to have such humongous source files is
 * just a tad bit too much idiocy in itself :)
 */
public class NoCatastrophicRegexBacktrackingForFyodorMikhaylovichPlease {
...
And Afanasy Ivanovitch heaved a deep sigh.
    ...
    public final boolean toBeContinued = true/*oh yes!*/;
    // Parts 2,3 and 4 are waiting!
}